      ...
      >
        ...
        <defs>
          <pattern id="tarot-halftone" x="0" y="0" width="4" height="4" patternUnits="userSpaceOnUse">
            <circle cx="2" cy="2" r="0.9" fill="#0a0606" />
          </pattern>
        </defs>
        {/* Card body */}
        <rect x="6" y="6" width="188" height="288" fill="#f4eedc" stroke="#0a0606" strokeWidth="3" />
        <rect x="14" y="14" width="172" height="272" fill="none" stroke="var(--color-accent)" strokeWidth="1.5" />
        {/* Top numeral */}
        <text x="100" y="38" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="9" fill="#0a0606" letterSpacing="3" fontWeight="700">
          — {numeral} —
        </text>
        <line x1="40" y1="46" x2="160" y2="46" stroke="#0a0606" strokeWidth="1" />
        {/* Halftone field */}
        ...
        {/* Bottom labels */}
        <line x1="40" y1="225" x2="160" y2="225" stroke="#0a0606" strokeWidth="1" />
        <text x="100" y="248" textAnchor="middle" fontFamily="var(--font-display)" fontStyle="italic" fontWeight="900" fontSize="15" fill="#0a0606">
          {title}
        </text>
        <text x="100" y="265" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="7" fill="var(--color-accent)" letterSpacing="2.5">
          {subtitle}
        </text>
        <text x="100" y="278" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="6" fill="#0a0606" opacity="0.6" letterSpacing="2">
          {owner}
        </text>
      </svg>
    </div>
